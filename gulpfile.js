...
/**
 * Convert from Bower supplied to Google-CDN hosted vendor code
 * @return {Stream}
 */
gulp.task('googlecdn', function () {
  log('Changing from bower to Google CDN');

  return gulp
    .src('/src/client/index.html')
    .pipe(plug.googleCdn(require('./bower.json')))
    .pipe(gulp.dest(paths.build));
});
 ...
 * @return {Stream}
 */
// gulp.task('rev-and-inject', ['js', 'css', 'vendorjs', 'vendorcss'], function () {
gulp.task('rev-and-inject', ['googlecdn', 'js', 'css', 'vendorjs', 'vendorcss'], function () {
